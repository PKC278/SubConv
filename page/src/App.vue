<template>
    <div class="container">
        <el-card class="box-card">
            <div class="header">
                <a href="https://github.com/PKC278/SubConv" target="_blank">
                    <span>SubConv&nbsp;</span>
                    <span>
            ...
            <el-form label-position="top" label-width="100px" class="main">
                ...
                <template v-if="form.advanced_switch">
                    ...
                    <el-form-item label="配置文件更新间隔">
                        <el-input v-model="form.time" style="width: 100px" placeholder="86400"></el-input>
                        &nbsp;秒
                    </el-form-item>
                </template>
        ...
        <div class="footer">
            <div>
                ...
                <span>
                    <a href="https://github.com/SubConv/SubConv" target="_blank">SubConv</a>
                </span>
            </div>
            <div>
                <span>
                    <i class="fa fa-pencil" aria-hidden="true"></i>
                    UI design modified from
                </span>
                <span>
